        ...
        public SampleDataSource()
        {
           // String ITEM_CONTENT = String.Format("");
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-1",
                    ...
                    group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Renewable", bgColour = "#6495ED", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/11.jpg")), CurrentStatus = "Clean Energy" });
            group1.Items.Add(new SampleDataItem("Group-1-Item-2",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Power Consumption", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/12.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-3",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Solar Power", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/13.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-4",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "How Solar Power Works?", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/14.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-5",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Pros and Cons", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/15.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-6",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "How to Build?", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/16.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-7",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Being Economical", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/17.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-8",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Build a Wind Power", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/18.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-9",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Wind Power", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/19.jpg")), CurrentStatus = "Clean Energy" });
			group1.Items.Add(new SampleDataItem("Group-1-Item-10",
                     ...
                     group1) { CreatedOn = "Group", CreatedTxt = "Commands & Actions", CreatedOnTwo = "Item", CreatedTxtTwo = "Wind Power Work", bgColour = "#DAA520", Image = new BitmapImage(new Uri(new Uri("ms-appx:///"), "Assets/Images/20.jpg")), CurrentStatus = "Clean Energy" });
